...
export default function MobileSidebarMenu() {
  ...
  return (
    <>
      ...
      <style jsx>{`
        .mobile-menu-button{display:none;position:fixed;top:14px;right:14px;z-index:2147482500;width:46px;height:46px;padding:0;border:1px solid rgba(239,168,40,.3);border-radius:14px;background:rgba(5,12,13,.92);box-shadow:0 14px 35px rgba(0,0,0,.35);backdrop-filter:blur(14px);cursor:pointer}
        ...
        .mobile-menu-drawer{position:absolute;top:0;right:0;width:min(86vw,360px);height:100%;padding:20px 18px calc(24px + env(safe-area-inset-bottom));overflow-y:auto;border-left:1px solid rgba(239,168,40,.18);background:radial-gradient(circle at 85% 5%,rgba(239,168,40,.12),transparent 30%),#060b0d;transform:translateX(102%);transition:transform .24s ease;box-shadow:-25px 0 70px rgba(0,0,0,.5)}
        ...
        .mobile-menu-brand{display:flex;align-items:center;gap:10px}.mobile-menu-brand>span{width:38px;height:38px;display:grid;place-items:center;border:1px solid rgba(239,168,40,.24);border-radius:12px;color:#efaa2f;font-weight:900}.mobile-menu-brand b,.mobile-menu-brand small{display:block}.mobile-menu-brand b{font-size:12px;letter-spacing:.18em}.mobile-menu-brand small{margin-top:3px;color:#7f8c98;font-size:7px;letter-spacing:.14em}.mobile-menu-head>button{width:38px;height:38px;border:1px solid rgba(255,255,255,.1);border-radius:50%;background:rgba(255,255,255,.04);color:white;font-size:22px}
        nav{display:grid;margin-top:18px}nav a{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:17px 3px;border-bottom:1px solid rgba(255,255,255,.08);color:#e7eeec;font-size:15px;font-weight:700}nav a b{color:#687680;font-size:13px}nav a.account{margin-top:18px;padding:15px 17px;border:0;border-radius:999px;background:#efaa2f;color:#160f02}nav a.account b{color:#160f02}nav a.onboard{margin-top:10px;padding:15px 17px;border:1px solid rgba(53,228,166,.24);border-radius:999px;color:#efaa2f}nav a.onboard b{color:#efaa2f}.mobile-menu-drawer>p{margin:26px 2px 0;color:#6f7d88;font-size:10px;line-height:1.65}
