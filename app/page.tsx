...
const benefits = [
  ...
  ["Consistent execution", "Expert Advisors and systematic strategies can monitor eligible opportunities, apply configured position rules and execute without requiring constant screen time."],
  ["Structured risk controls", "Trade size, stop-loss logic, exposure limits, trading hours and daily safeguards can be built into strategy configurations."],
  ["Measurable decisions", "Systematic trading creates records that can be reviewed, tested and improved instead of relying on memory, instinct or emotional interpretation."],
];

const copySteps = [
  ["Understand the strategy", "Review how the strategy operates, its objectives, limitations and the risks involved before proceeding."],
  ["Complete guided onboarding", "Tell us about your experience, objectives and risk tolerance so we can help identify the most suitable route."],
  ["Select an eligible profile", "Review the available strategy or management profile, its operating approach and risk characteristics before activation."],
  ["Activate and monitor", "Once approved, the selected service operates according to its defined mandate while you retain visibility of your account and risk settings."],
];

const profiles = [
  { name: "Gencouv Core", label: "Measured participation", description: "Designed for clients who prefer more controlled market exposure, lower strategy intensity and a steadier automation framework.", items: ["Systematic execution", "Defined risk parameters", "Structured monitoring"], start: "core_profile" },
  ...
  return <main>
    ...
    <section className="copyHero shell">
      <div className="copyHeroText">
        <div className="copyPill">AI-POWERED TRADING TECHNOLOGY</div>
        <h1>Smarter Strategies.<br/><em>Disciplined Capital. Built for the Markets.</em></h1>
        <p>Gencouv brings together intelligent trading strategies, automated systems and capital management solutions designed to help clients navigate the markets with structure, transparency and risk awareness.</p>
        <div className="copyHeroActions"><a className="copyPrimary" href="/about">Explore Gencouv <span>↗</span></a><a className="secondary" href="/copy-trading">Discover Our Strategies</a></div>
        <div className="copyProof"><span><b>Capital Management</b><small>Structured approaches to managed trading capital</small></span><span><b>Trading Strategies</b><small>Systematic approaches across different market conditions</small></span><span><b>Automated Systems</b><small>Expert Advisors and rule-based execution</small></span></div>
      </div>

      <div className="copyHeroVisual" aria-label="Illustration of Gencouv systematic trading technology and connected market strategies">
        ...
        <div className="copyPhone"><div className="phoneTop"><span>GENCOUV SYSTEMS</span><b>LIVE</b></div><div className="phoneAccount"><small>Active strategy</small><strong>Gencouv Core</strong></div><div className="phoneGraph"><svg viewBox="0 0 320 130" preserveAspectRatio="none" aria-hidden="true"><path d="M0 106 C28 96 35 72 58 79 S92 103 116 61 S154 48 174 70 S207 72 226 42 S268 58 320 14"/></svg></div><div className="phoneStats"><span><small>Status</small><b>Systematic</b></span><span><small>Risk profile</small><b>Core</b></span></div><a href={`${telegram}?start=website`} target="_blank" rel="noreferrer">Explore Gencouv</a></div>
        <div className="copyBadge green">SYSTEM</div><div className="copyBadge blue">STRATEGY</div>
      </div>
    </section>

    <section id="copy-trading" className="section shell"><div className="sectionHead"><div><div className="eyebrow left">HOW COPY TRADING WORKS</div><h2>A guided route from strategy selection to controlled execution.</h2></div><p>Copy trading is one of several ways Gencouv can deliver systematic market participation. We guide each prospective client through suitability, strategy selection and risk-profile review before activation.</p></div><div className="knowledgeGrid">{copySteps.map(([title,description],i)=><article className="knowledgeCard" key={title}><span>0{i+1}</span><h3>{title}</h3><p>{description}</p></article>)}</div><div className="copyHeroActions" style={{marginTop: "28px"}}><a className="copyPrimary" href={`${telegram}?start=get_started`} target="_blank" rel="noreferrer">Get started <span>↗</span></a><a className="secondary" href="/copy-trading">Learn more</a><a className="secondary" href="#support">Contact support</a></div></section>
    ...
    <section className="finalCta shell"><div className="eyebrow">GUIDED ONBOARDING</div><h2>Find the Gencouv solution that fits your objectives.</h2><p>Our onboarding assistant helps you understand the available services, asks suitability questions and helps identify the route that fits your experience, objectives and risk tolerance.</p><div className="copyHeroActions"><a className="primary" href={`${telegram}?start=website_final`} target="_blank" rel="noreferrer">Get started <span>↗</span></a><a className="secondary" href="#support">Contact support</a></div></section>

    <footer className="footer shell"><div className="brand"><span>G</span><div><b>GENCOUV</b><small>AI TRADING TECHNOLOGY</small></div></div><p>Capital management, trading strategies, automated trading systems, Expert Advisors and market intelligence tools.</p><div><a href="/about">About</a><a href="/copy-trading">Copy trading</a><a href="/marketplace">Marketplace</a><a href="/testimonials">Testimonials</a><a href="#support">Contact support</a><a href="/terms">Terms</a><a href="/privacy">Privacy Policy</a><a href="/risk-disclosure">Risk Disclosure</a><a href={`${telegram}?start=website_footer`} target="_blank" rel="noreferrer">Get on board</a></div><small>Gencouv does not hold client funds. © 2026 Gencouv. Trading involves substantial risk. Results are not guaranteed and past performance does not guarantee future results.</small></footer>
