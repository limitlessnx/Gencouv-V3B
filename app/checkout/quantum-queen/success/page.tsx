export default function QuantumQueenCheckoutSuccessPage() {
  return (
    <main>
      <nav className="nav shell"><a className="brand" href="/"><span>G</span><div><b>GENCOUV</b><small>AI TRADING TECHNOLOGY</small></div></a><div className="links"><a href="/marketplace">Marketplace</a><a href="/dashboard">My Library</a></div></nav>
      <section className="shell successWrap">
        <div className="successCard">
          <div className="statusMark">✓</div>
          <div className="eyebrow">QUANTUM QUEEN PAYMENT RETURNED</div>
          ...
          <div className="notice"><b>What happens next</b><span>After confirmation, the Quantum Queen license is attached to your signed-in account. If you checked out as a guest, create or sign in to a Gencouv account with the same verified email used at checkout and the purchase will be claimed into My Library.</span></div>
          <div className="actions"><a className="primary" href="/dashboard">Open My Library</a><a className="secondary" href="/marketplace">Return to Marketplace</a></div>
        </div>
      </section>
