    ...
    <section id="catalog" className="section shell">
      ...
      <article className="eaCard">
        <div className="eaGallery">
          <figure><img src="/sixtynine-live-signal.svg" alt="SixtyNine EA public live signal performance graphic"/><figcaption>Public live-signal material</figcaption></figure>
