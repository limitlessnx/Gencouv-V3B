  ...
  return <main>
    ...
    <section id="catalog" className="section shell">
      ...
      <article className="eaCard">
        ...
        <div className="productActions"><a className="primary" href="/checkout/sixtynine">Purchase · $2,000</a><a className="secondary" href={`${telegram}?start=sixtynine_ea`} target="_blank" rel="noreferrer">Ask Gencouv Support ↗</a></div>
      </article>
    </section>
