...
export default function PortfolioManagementPage() {
  return (
    <main>
      <nav className="nav shell"><a className="brand" href="/"><span>G</span><div><b>GENCOUV</b><small>AI TRADING TECHNOLOGY</small></div></a><div className="links"><a href="/">Home</a><a href="#how-it-works">How it works</a><a href="#performance">Performance</a><a href="/marketplace">Marketplace</a></div><a className="navCta" href={telegram} target="_blank" rel="noreferrer">Get on board</a></nav>

      <section className="infoHero shell"><div className="eyebrow left">GENCOUV PORTFOLIO MANAGEMENT</div><h1>One managed strategy. Your own brokerage account.</h1><p>Gencouv provides a managed portfolio strategy for eligible clients through supported broker infrastructure. We do not accept or hold client deposits. You open and fund your own brokerage account, complete onboarding and, if approved, participate in the managed strategy.</p><div className="heroActions"><a className="primary" href={telegram} target="_blank" rel="noreferrer">Begin onboarding ↗</a><a className="secondary" href={myfxbook} target="_blank" rel="noreferrer">View verified performance</a></div></section>
